...
import { conjugate_grad, conjugate_grad_spMatrix } from '../../lib/conjugate_grad';
...
describe(" Solve a linear equation Ax = b", () => {
    ...
    it("conjugate gradient method using sparse matrix", () => {
        let P = new SparseMatrix(3, 3, new Array<[number, number, number]>([0, 0, 7], [0, 1, 7], [0, 2, 7], [1, 0, 7], [1, 1, 1], [1, 2, 3], [2, 0, 1], [2, 1, 0], [2, 2, 3]));
